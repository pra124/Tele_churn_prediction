...
def chi_square(df,df1,y):
    try:
        ...
        df1_filteres=df1.drop(columns=remove_features)
        logger.info(f"Removed columns chi2: {list(remove_features)}")
        return  df_filtered,df1_filteres
