...
def iteration_decision_tree(x_train, x_test):
    try:
        ...
        x_train['TotalCharges_DT_x_train_itr'] = x_train_cont_imp['TotalCharges']
        x_test['TotalCharges_DT_x_test_itr'] = x_test_cont_imp['TotalCharges']
        std_before = total_charges.std()
        std_after = x_train['TotalCharges_DT_x_train_itr'].std()
